...
BulletR::BulletR() : ContactR() {}

void BulletR::updateContactPointsFromManifoldPoint(const btPersistentManifold& manifold,
                                                   const btManifoldPoint& point, bool flip,
                                                   double scaling, SP::NewtonEulerDS ds1,
...
void BulletR::updateRelativeContactPointsFromManifoldPoint(
    const btPersistentManifold& manifold, const btManifoldPoint& point, bool flip,
    double scaling, SP::NewtonEulerDS ds1, SP::NewtonEulerDS ds2) {
  ...
  ContactR::updateRelativeContactPoints(va, vb, vn * (flip ? -1 : 1));
}
