...
void NewtonEuler1DR::computeContactPointsFromRelativeContactPoints(
    const BlockVector& q0, SiconosVector& r_pc1,
    SiconosVector& r_pc2, SiconosVector& r_nc, SiconosVector& r_t1, SiconosVector& r_t2,
    SiconosVector& pc1, SiconosVector& pc2, SiconosVector& nc, SiconosVector& t1, SiconosVector& t2 )
    {
  // Contact points and normal are stored as relative to q1 and q2, if
  // no q2 then pc2 and normal are absolute.
